 ...
 * {@link OnPersonaClicada} interface
...
public class PersonaFragment extends Fragment {
    ...
    private OnPersonaClicada mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnPersonaClicada) {
            mListener = (OnPersonaClicada) context;
        } else {
    ...
    public interface OnPersonaClicada {
        void onPersonaClicada(int codiPersona);
    }
}
